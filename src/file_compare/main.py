...
dotenv.load_dotenv("../../deployments/local_envs/local-infra.env")
...
postgres_conn_str: str = f"postgresql://{os.environ.get('POSTGRES_USER')}:{os.environ.get('POSTGRES_USER')}@localhost:5432/postgres"
